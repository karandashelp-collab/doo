...
public class WebSeriesList {
    ...
    public WebSeriesList(int ID, int type, String title, String year, String thumbnail, String custom_tag, String custom_tag_background_color, String custom_tag_text_color) {
        this.ID = ID;
        Type = type;
        Title = title;
        Year = year;
