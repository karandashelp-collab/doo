...
public class EpisodeList {
    ...
    public EpisodeList(int id, String series_Name, String episoade_Name, String episoade_image, String episoade_description, int season_id, int downloadable, int type, String source, String url, int skip_available, String intro_start, String intro_end, boolean play_Premium, boolean downloadPremium, String drmUuid, String drmLicenseUri, int userID, boolean playPremium, int seriesID) {
        this.id = id;
    ...
    public boolean isPlayPremium() {
        return playPremium;
    }

    public void setPlayPremium(boolean playPremium) {
        this.playPremium = playPremium;
    }
